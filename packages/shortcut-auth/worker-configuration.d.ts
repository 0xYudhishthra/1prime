/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 27f95bdf8a00669c8cf30e5c51b9c9b6)
// Runtime types generated with workerd@1.20250730.0 2025-07-24 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		DATABASE_URL: string;
		ZERODEV_ARBITRUM_SEPOLIA_RPC: string;
		ZERODEV_ETHEREUM_SEPOLIA_RPC: string;
		ZERODEV_OPTIMISM_SEPOLIA_RPC: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL" | "ZERODEV_ARBITRUM_SEPOLIA_RPC" | "ZERODEV_ETHEREUM_SEPOLIA_RPC" | "ZERODEV_OPTIMISM_SEPOLIA_RPC">> {}
}

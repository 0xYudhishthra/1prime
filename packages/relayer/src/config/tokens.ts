...
export const TOKEN_CONFIGS: Record<string, TokenConfig> = {
  usdc: {
    ...
    addresses: {
      ...
      "eth-sepolia": "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", // Example testnet address
  ...
  usdt: {
    ...
    addresses: {
      ...
      "eth-sepolia": "0xdAC17F958D2ee523a2206206994597C13D831ec7", // Example testnet address
